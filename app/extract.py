...
download_uris = [
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/category.zip',
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/date.zip',
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/date_rev.zip',
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/listing.zipp',
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/sale.zip',
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/user.zip',
    'https://github.com/Stefen-Taime/elt_pipeline/blob/master/data/venue.zip'
]
